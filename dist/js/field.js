...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-social-field', __webpack_require__(3));
  Vue.component('detail-nova-social-field', __webpack_require__(6));
  Vue.component('form-nova-social-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        createLink: function createLink(value) {
            if (this.isGithub) {
    ...
    computed: {
        ...
        isGithub: function isGithub() {
            return !!this.field.Github;
        },
        isTwitter: function isTwitter() {
            return !!this.field.Twitter;
        },
        isLinkedIn: function isLinkedIn() {
            return !!this.field.LinkedIn;
        },
        getLinkedInName: function getLinkedInName() {
            var name = this.field.value.split('-');

            return this.ucfirst(name[0]) + ' ' + this.ucfirst(name[1]);
        }
    }
});
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "flex items-center flex-items-center" }, [
        _c("div", { staticClass: "mr-3" }, [
          _vm.isGithub
            ? _c(
                ...
                [
                  _c("title", [_vm._v("ionicons-v5_logos")]),
                  _c("path", {
                    attrs: {
                      d:
      ...
      _c("template", { slot: "value" }, [
        _vm.field.value
          ? _c(
              ...
              {
                staticClass:
                  "text-primary inline-flex items-center dim cursor-pointer no-underline",
                attrs: {
                  href: _vm.createLink(_vm.field.value),
                  target: "_blank"
                }
              },
              [
                _vm.isLinkedIn
                  ? _c("span", { staticClass: "text-primary font-bold" }, [
                      _vm._v("@" + _vm._s(_vm.getLinkedInName))
                    ])
                  : _c("span", { staticClass: "text-primary font-bold" }, [
